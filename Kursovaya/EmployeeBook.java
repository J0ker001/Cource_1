...
public class EmployeeBook {
    ...
    public void printDepartmentEmployee() {
        ...
        String b = null;
        for (int i = 0; i < persArray.length; i++) {
            if (persArray[i].getDepartment() == 1){
                a =  persArray[i].getDepartment() + " " + persArray[i].getName() + persArray[i+1].getName();
                return;

            }  if (persArray[i].getDepartment() == 2){
                b =  persArray[i].getDepartment() + " " + persArray[i].getName();;
            }
        }
